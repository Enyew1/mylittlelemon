...
function BookingPage() {
  return (
    <Box h="100%" bg="#495E57" textColor="white" marginBottom="auto">
      <VStack marginLeft="15vw" marginRight="15vw">
        ...
        <FormControl paddingTop="5vh" isRequired>
          <HStack gap={2}>
            ...
            <Input bg="white" type="first name" placeholder="Enyew" />

            <FormLabel textColor="white">Last Name</FormLabel>
            <Input bg="white" type="last name" placeholder="Luel" />
          </HStack>

          <FormLabel textColor="white" paddingTop="5%">
            Email address
          </FormLabel>
          <Input bg="white" type="email" placeholder="enyew@gmail.com" />
          <FormHelperText textColor="gray.300">
            We'll never share your email.
          </FormHelperText>

          <FormLabel textColor="white">Phone</FormLabel>
          <Input bg="white" type="email" placeholder="9999999" />
          <FormHelperText textColor="gray.300">
            We'll only call in emergencies.
          </FormHelperText>
          ...
          <HStack w="100%" paddingTop="5%">
            ...
            <FormLabel w="auto" textColor="white">
              Date and Time
            </FormLabel>
            <Input
              bg="white"
      ...
      >
        <FormControl>
          <FormLabel as="table" textColor="white" p>
          ...
          <RadioGroup colorScheme="white">
            ...
            <FormHelperText textColor="gray.300">
              We unfortunately cannot guarantee the availability.
            </FormHelperText>
          </RadioGroup>
        </FormControl>
        <FormControl>
        ...
        <Button bg="#F4CE14" w="max-content" textColor="#495E57">
          Proceed to payment
        </Button>
      </VStack>
    </Box>
